  ...
  useEffect(() => {
    ...
    const updateChartData = async () => {
      try {
        ...
        // Log the parameters before fetching data
        console.log(`Fetching data for ${stockSymbol} from ${startTimestampUnix} to ${endTimestampUnix} with resolution ${resolution}`);
        ...
        if (result && result.c && result.t && result.c.length > 0 && result.t.length > 0) {
